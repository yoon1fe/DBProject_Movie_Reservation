...
<html>
   ...
   <div id="div1" style="height: auto; width: 100%; border:1px solid black;"></div>
      ...
      <font style="position:relative;left:250px;top:32px;font-weight:bold;font-size:20px;">아 이 디</font>
      <center>
         <input type="text" style = "width:250px; height:40px;" name="input_id"/>
      </center>
      <font style="position:relative;left:250px;top:32px;font-weight:bold;font-size:20px;">비밀번호</font>      
      <center>
